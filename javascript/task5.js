...
function getSeason(month) {
    if (typeof month === "number") {
        if (season.winter.months.indexOf(month) !== -1)
            return 1;
        if (season.spring.months.indexOf(month) !== -1)
            return 2;
        if (season.summer.months.indexOf(month) !== -1)
            return 3;
        if (season.autumn.months.indexOf(month) !== -1)
            return 4;
    }
    if (typeof month === "string") {
        if (season.winter.names.indexOf(month) !== -1)
            return "winter";
        if (season.spring.names.indexOf(month) !== -1)
            return "spring";
        if (season.summer.names.indexOf(month) !== -1)
            return "summer";
        if (season.autumn.names.indexOf(month) !== -1)
            return "autumn";
    }
